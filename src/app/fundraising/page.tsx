      ...
      <main className={styles.main}>
        ...
        <ContentBox>
          ...
          <p className={styles.contentP}>
            ...
            Let’Er Buck! Make your event worry-free by inviting others to get a
            wash while they support your cause. We will donate either $1 per
            vehicle or $300 during the fundraiser, whichever is higher! Fill out
            the form below and get in touch with us to discuss how we can help
