...
const HomeBanner: React.FC = () => {
    return (
        ...
        <div className={styles.homeBanner}>
          ...
          <Link href="https://www.carwashlogin.com/leterbuckcarwash/customerportal/signupforunlimited.aspx"><Image src="/sign-me-up-btn.png" alt="blue sign me up button" width={170} height={30} className={styles.bannerBtn}></Image></Link>
