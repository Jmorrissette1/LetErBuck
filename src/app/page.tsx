			...
			<main className={styles.main}>
				...
				<div className={styles.mobileHome}>
					...
					<p className={styles.homeP}>
						This ain’t your average wash, we give your car the cowboy treatment.
						Tough, fast, and clean every dang time.
					</p>
				</div>
				<div className={styles.homeBtnBox}>
					...
					<Link href="https://www.carwashlogin.com/leterbuckcarwash/customerportal/signupforunlimited.aspx">
						<button className={styles.signMeUpBtn}>Sign Me Up</button>
					</Link>
				</div>
				<HomeBanner />
				<div className={styles.bannerM}></div>
			</main>
