        ...
        <ContentBox>
          <p className={styles.contentP}>
            ...
            <em>
              ...
              cleaning your car in four minutes or less—all year round. Our name
              was chosen to honor Wyoming’s western tradition, to pay homage to
              America’s #1 State: Wyoming, and the battle cry of UW’s Cowboy
              football team!
            </em>
          </p>
          ...
          <p className={styles.contentP}>
            ...
            bays, featuring powerful suction nozzles under well lit canopies—no
            more weak, low-power vacuums that drain you of your change!
          </p>
          <p className={styles.contentP}>
            Choose from four wash packages as you enter our car wash lane and
            pay with your choice of credit/debit card, cash, unlimited wash club
            membership, or gift card.
          </p>
          <p className={styles.contentP}>
            Once you enter the wash tunnel, a trained associate will assist you
            and your vehicle onto the conveyor. Then they will instruct you to
            place your car into neutral, take your hands from the wheel, and sit
            back and relax while our industry-leading equipment does all the
            work!
          </p>
          <p className={styles.contentP}>
            The car wash experience at Let’Er Buck allows for operation in
            almost any weather. Over 7,000 square feet of concrete is heated at
            both the entrance and exit of the wash. The loading area is located
            inside the wash to assist with inclement and freezing weather, while
            the tunnel and vacuum areas are well lit so our customers feel safe
            and comfortable while on site.
          </p>
          <p className={styles.contentP}>
